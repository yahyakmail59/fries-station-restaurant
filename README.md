...
> رقم واتساب المبدئي هو `+972 59 786 2389`. يمكن تغييره في أي وقت من
> `لوحة التحكم ← إعدادات الموقع ← التواصل` من دون تعديل الكود.

التوصيل مجهّز تقنيًا لكنه **معطّل افتراضيًا**. يمكن تشغيله من
`لوحة التحكم ← إعدادات الموقع ← تشغيل الطلبات`؛ عند تعطيله يختفي من السلة
ويرفض الخادم أي طلب توصيل مباشر، بينما يبقى الاستلام والحجز مفعّلين.
