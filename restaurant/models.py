...
class RestaurantSettings(TimeStampedModel):
    ...
    hero_title_ar = models.CharField(max_length=180, default='فرايز مقرمشة تُقلى عند الطلب', verbose_name='عنوان الواجهة بالعربية')
    hero_title_en = models.CharField(max_length=180, default='Fried to order. Your way.', verbose_name='عنوان الواجهة بالإنجليزية')
    hero_text_ar = models.TextField(default='اختر وجبتك وحجمك، راجع السعر، ثم أرسل طلبك جاهزًا عبر واتساب. متاح للاستلام أو التوصيل.', verbose_name='وصف الواجهة بالعربية')
    hero_text_en = models.TextField(default='Choose your meal and size, review the price, then send your ready order on WhatsApp. Pickup and delivery are available.', verbose_name='وصف الواجهة بالإنجليزية')
    ...
    menu_title_ar = models.CharField(max_length=160, default='اختر قسمك المفضل', verbose_name='عنوان أقسام القائمة بالعربية')
    menu_title_en = models.CharField(max_length=160, default='Choose a Menu Category', verbose_name='عنوان أقسام القائمة بالإنجليزية')
    featured_title_ar = models.CharField(max_length=160, default='اختيارات فرايز ستيشن', verbose_name='عنوان الأطباق المميزة بالعربية')
    featured_title_en = models.CharField(max_length=160, default='Fries Station Picks', verbose_name='عنوان الأطباق المميزة بالإنجليزية')
    ...
    order_cta_ar = models.CharField(max_length=100, default='ابدأ طلبك', verbose_name='نص زر الطلب بالعربية')
    order_cta_en = models.CharField(max_length=100, default='Start your order', verbose_name='نص زر الطلب بالإنجليزية')
    menu_cta_ar = models.CharField(max_length=100, default='شاهد المنيو والأسعار', verbose_name='نص زر القائمة بالعربية')
    menu_cta_en = models.CharField(max_length=100, default='See menu & prices', verbose_name='نص زر القائمة بالإنجليزية')
    whatsapp_panel_text_ar = models.CharField(max_length=180, default='راجع الأصناف والمجموع، ثم أرسل طلبك برسالة واتساب واحدة.', verbose_name='وصف صندوق واتساب بالعربية')
    whatsapp_panel_text_en = models.CharField(max_length=180, default='Review your items and total, then send the order in one WhatsApp message.', verbose_name='وصف صندوق واتساب بالإنجليزية')
